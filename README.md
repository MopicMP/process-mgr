...
> List, kill, monitor system processes

[![PyPI version](https://badge.fury.io/py/process-mgr.svg)](https://pypi.org/project/process-mgr/)
...
```bash
pip install process-mgr
```

## Quick Start

```python
from process_mgr import mgr
